...
export const PremiumLoader: React.FC<{
  ...
  const loaderVariants = {
    ...
    pulse: (
      <div className={`${sizeClasses[size]} bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 rounded-full animate-pulse`}></div>
    )
  };
...
export const SkeletonLoader: React.FC<{
  ...
  const skeletonTypes = {
    ...
    image: (
      <div className={`${baseClass} aspect-video ${className}`}></div>
    ),
    table: (
      <div className={`space-y-3 ${className}`}>
