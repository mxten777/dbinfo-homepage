      ...
      <div className="w-full max-w-4xl mx-auto flex flex-col gap-10">
        <div className="bg-white rounded-2xl shadow-xl border border-blue-100 p-8">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
            <div>
              <label className="block font-bold mb-2 text-gray-700 text-base">프로젝트명</label>
              <input name="project" value={form.project} onChange={handleChange} className="w-full border border-gray-300 rounded-xl px-4 py-2 focus:outline-blue-400 text-base" required />
            </div>
            <div>
              <label className="block font-bold mb-2 text-gray-700 text-base">고객사</label>
              <input name="client" value={form.client} onChange={handleChange} className="w-full border border-gray-300 rounded-xl px-4 py-2 focus:outline-blue-400 text-base" />
            </div>
            <div>
              <label className="block font-bold mb-2 text-gray-700 text-base">등록일</label>
              <input name="requestDate" value={form.requestDate} onChange={handleChange} className="w-full border border-gray-300 rounded-xl px-4 py-2 focus:outline-blue-400 text-base" />
            </div>
            <div>
              <label className="block font-bold mb-2 text-gray-700 text-base">프로젝트기간</label>
              <input name="period" value={form.period} onChange={handleChange} className="w-full border border-gray-300 rounded-xl px-4 py-2 focus:outline-blue-400 text-base" />
            </div>
            <div>
              <label className="block font-bold mb-2 text-gray-700 text-base">장소</label>
              <input name="location" value={form.location} onChange={handleChange} className="w-full border border-gray-300 rounded-xl px-4 py-2 focus:outline-blue-400 text-base" />
            </div>
            <div>
              <label className="block font-bold mb-2 text-gray-700 text-base">개발자</label>
              <input name="developer" value={form.developer} onChange={handleChange} className="w-full border border-gray-300 rounded-xl px-4 py-2 focus:outline-blue-400 text-base" />
            </div>
            <div>
            ...
            <div>
              ...
              <input name="statusChangeDate" value={form.deployments[0].statusChangeDate} onChange={handleChange} className="w-full border border-gray-300 rounded-xl px-4 py-2 focus:outline-blue-400 text-base" />
            </div>
